...
import { featuresCtaCopy } from '@/components/marketing/marketing-features-pages-data';
import { WhatsAppIcon } from '@/components/marketing/WhatsAppIcon';

type MarketingFeaturesCtaSectionProps = {
  onBookDemo?: () => void;
};

export function MarketingFeaturesCtaSection({ onBookDemo }: MarketingFeaturesCtaSectionProps) {
  const copy = featuresCtaCopy;

  return (
    <section id="features-cta" className="border-t border-black/[0.06] bg-white py-20 sm:py-28">
      <motion.div
