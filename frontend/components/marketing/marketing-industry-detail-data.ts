...
export const foodBeverageIndustryDetail = buildIndustry({
  ...
  proofMock: 'broadcast',
  hero: {
    eyebrow: 'Restaurant & QSR Growth',
    kicker: 'Stop losing hungry customers to slow phone lines and aggregator fees.',
    title: 'Own your guests.',
    titleHighlight: 'Recover lost margin.',
    subtitle:
      'Turn WhatsApp into your most profitable outlet. Send direct table-ready alerts, instant order status, and personalized loyalty offers that drive repeat dining.',
    outcomeStrip: ['Zero Aggregator Fees', 'Instant Table Alerts', 'Automated Waitlists', 'Repeat Diners'],
  },
  problem: {
