...
function KpiCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-slate-200/60 bg-white p-5 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.02)] hover:shadow-md transition-shadow">
      ...
      <div className="relative flex items-start justify-between gap-3">
        ...
        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-slate-50 text-slate-700 shadow-sm border border-slate-100">
          ...
          >
            <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              {Array.from({ length: 8 }).map((_, i) => (
                <div key={i} className="relative overflow-hidden rounded-2xl border border-slate-200/60 bg-white p-5 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.02)]">
            ...
            <div className="grid gap-4 lg:grid-cols-3">
              <div className="h-[300px] rounded-2xl border border-slate-200 bg-white p-5 lg:col-span-2 animate-pulse" />
              <div className="h-[300px] rounded-2xl border border-slate-800 bg-slate-900 p-5 animate-pulse" />
            </div>
          </motion.div>
        ) : data ? (
          <motion.div 
