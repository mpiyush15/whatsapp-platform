  ...
  const billingLinks = [
    {
      ...
      href: `/projects/${projectId}/subscriptions`,
      icon: CreditCard,
      color: "blue"
    },
    {
      ...
      href: `/checkout?projectId=${projectId}`,
      icon: ArrowRight,
      color: "green"
    },
    {
      ...
      href: `/projects/${projectId}/account`,
      icon: DollarSign,
      color: "purple"
    },
    {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
            ...
            <Link href={`/projects/${projectId}/subscriptions`} className="text-green-600 hover:text-green-700 font-semibold text-sm">
              View Details →
            </Link>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500">
            ...
            <Link href={`/checkout?projectId=${projectId}`} className="text-purple-600 hover:text-purple-700 font-semibold text-sm">
              Upgrade Now →
            </Link>
          </div>
        </div>
