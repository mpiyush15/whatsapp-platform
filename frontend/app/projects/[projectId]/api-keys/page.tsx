...
export default function ApiKeysPage() {
  ...
  const fetchApiKeys = async () => {
    try {
      setLoading(true)
      const response = await axios.get(`${API_URL}/settings/api-keys?projectId=${projectId}`, {
        headers: getHeaders()
      })
  ...
  const handleGenerateKey = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_URL}/settings/api-keys?projectId=${projectId}`,
        { name: keyName },
        { headers: getHeaders() }
      )
  ...
  const handleDeleteKey = async (keyId: string) => {
    ...
    try {
      const response = await axios.delete(`${API_URL}/settings/api-keys/${keyId}?projectId=${projectId}`, {
        headers: getHeaders()
      })
  ...
  const handleRevokeKey = async (keyId: string) => {
    ...
    try {
      const response = await axios.post(
        `${API_URL}/settings/api-keys/${keyId}/revoke?projectId=${projectId}`,
        {},
        { headers: getHeaders() }
      )
