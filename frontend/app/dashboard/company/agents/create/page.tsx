...
export default function CreateAgentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(true);
      setLoginUrl(data.loginUrl || data.invitationUrl || '');
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Login details were generated. You can share them with the agent if email delivery is unavailable.
            </p>

            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              <p className="text-sm text-gray-600 mb-3">Live chat login URL:</p>
              ...
              {temporaryPassword && (
                <div className="mt-5 text-left">
                  <p className="text-sm text-gray-600 mb-2">6 digit password:</p>
                  <code className="inline-block rounded-lg border border-gray-300 bg-white px-4 py-3 text-xl font-bold tracking-[0.35em] text-gray-900">
                    {temporaryPassword}
                  </code>
                </div>
              )}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6 text-left">
              ...
              <ol className="list-decimal list-inside space-y-2 text-blue-800">
                <li>Share the login URL and password if the email was not delivered</li>
                <li>Agent logs in with their email and the 6 digit password</li>
                <li>They land on the project live chat inbox</li>
              </ol>
            </div>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <p className="text-gray-600 mb-8">
            Add a new agent to your team and send them a 6 digit live chat login.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4 pt-6">
              ...
              >
                {loading ? 'Creating...' : 'Create Agent & Send Login'}
              </button>
              <button
                type="button"
                onClick={() => router.back()}
          ...
          <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm text-blue-800">
              <strong>Tip:</strong> After creating the agent, they receive the project live chat URL and a 6 digit password.
            </p>
          </div>
        </div>
      </div>
