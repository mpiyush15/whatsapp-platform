  ...
  const fetchContacts = async () => {
    try {
      ...
      if (conversationsResponse.ok) {
        ...
        const conversations = conversationData.data?.conversations || conversationData.conversations || []
        ...
        conversations.forEach((conv: any) => {
          ...
          upsertDisplayContact(contactMap, {
            userPhone: phone,
            userName: conv.userName || conv.customerName || phone,
            source: contactMap.get(phone)?.source || "Conversation",
            type: contactMap.get(phone)?.type || "customer",
    ...
    <div className="p-6 space-y-4">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">Saved contacts and WhatsApp conversations</p>
        </div>
