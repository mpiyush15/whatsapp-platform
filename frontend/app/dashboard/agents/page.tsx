...
interface Agent {
  ...
  role: string;
  department?: string;
  status: 'active' | 'inactive' | 'busy' | 'offline' | 'away';
  createdAt: string;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="mt-2 text-3xl font-bold text-green-600">{agents.filter(a => a.status === 'active').length}</div>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            <div className="text-gray-500 text-sm font-medium">Inactive Agents</div>
            <div className="mt-2 text-3xl font-bold text-red-600">{agents.filter(a => a.status === 'inactive').length}</div>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
