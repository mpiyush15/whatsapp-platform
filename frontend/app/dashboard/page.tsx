...
export default function DashboardPage() {
  ...
  const fetchProjects = async () => {
    try {
      ...
      const apiProjects = Array.isArray(data.data) ? data.data : []
      const projectList = [...apiProjects]
      
      // Inject demo Pixels project
      projectList.push({
        projectId: 'pixels-demo-123',
        name: 'Pixels Salon & Spa (Demo)',
      ...
      // ✅ CRITICAL: Auto-redirect disabled as per request
      // if (apiProjects.length === 1) {
      //   const pId = apiProjects[0].projectId || apiProjects[0].id
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            {projects.length === 0 ? (
              ...
              <div className="flex items-center justify-center min-h-[24rem]">
                <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-12 w-full text-center">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                  {projects.map(project => {
                    ...
                    const destination = projectId === 'pixels-demo-123' ? `/projects/${projectId}/pixels` : `/projects/${projectId}`
                    return (
                      <Link
                        key={projectId}
                        href={destination}
                      ...
                      >
                        ...
                        <div className="flex flex-col gap-2 mb-4">
                          ...
                          <span
                            className={`w-fit px-3 py-1 rounded-full text-xs font-semibold whitespace-nowrap ${
          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-200 p-8 h-full min-h-[24rem]">
            <div className="flex flex-col items-center justify-center h-full text-center">
              <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4">
                <FolderOpen className="w-8 h-8 text-gray-400" />
              </div>
              <h2 className="text-xl font-bold text-gray-900 mb-2">Second Column Ready</h2>
              <p className="text-gray-500 max-w-sm">
                This is the right column placeholder. Ready for your reference design.
              </p>
            </div>
          </div>
        </div>
