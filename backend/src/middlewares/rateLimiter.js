...
// Template creation limiter - 5 per hour
export const createTemplateLimiter = rateLimit({
  windowMs: 60 * 60 * 1000,  // 1 hour
  max: 5,                     // 5 templates per hour
  message: {
    success: false,
    code: 'TEMPLATE_CREATE_LIMIT_EXCEEDED',
    message: 'You have reached the limit of creating 5 templates per hour. Please wait before creating more.',
    retryAfter: 3600
  },
  standardHeaders: true,
  legacyHeaders: false,
...
export const submitTemplateLimiter = rateLimit({
  windowMs: 60 * 60 * 1000,  // 1 hour
  max: 5,                     // 5 templates per hour
  message: {
    success: false,
    code: 'TEMPLATE_SUBMIT_LIMIT_EXCEEDED',
    message: 'You have reached the limit of submitting 5 templates to Meta per hour. Please wait before submitting more.',
    retryAfter: 3600
  },
  standardHeaders: true,
  legacyHeaders: false,
