...
// Catalog Fields Management
import * as catalogController from '../controllers/catalogController.js';
router.post('/admin/catalog', requireJWT, requireSuperAdmin, catalogController.createCatalogField);
router.put('/admin/catalog/:key', requireJWT, requireSuperAdmin, catalogController.updateCatalogField);
router.delete('/admin/catalog/:key', requireJWT, requireSuperAdmin, catalogController.deleteCatalogField);
