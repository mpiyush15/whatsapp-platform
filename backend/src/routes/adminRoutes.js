...
/**
 * GET /api/admin/platform-contacts
 */
router.get('/platform-contacts', getPlatformContacts);

/**
 * POST /api/admin/platform-leads/import
 */
router.post('/platform-leads/import', importPlatformLeads);
...
/**
 * POST /api/admin/accounts/:accountId/whatsapp/connect
 * Manually connect WhatsApp for a client (superadmin only)
 */
router.post('/accounts/:accountId/whatsapp/connect', adminConnectWhatsApp);
