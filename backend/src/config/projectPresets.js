...
export const PROJECT_VERTICALS = ['whatsapp', 'healthcare', 'ecommerce', 'pathology', 'education'];
...
export const PROJECT_PRESETS = [
  ...
  },
  {
    ...
    vertical: 'education',
    label: 'Education - Coaching Institute',
    description: 'Enquiry management, batch management, fee management, and WhatsApp automations for coaching institutes.',
    defaultHomePath: 'education',
    features: ['Enquiries', 'Batches', 'Courses', 'Fee Management', 'WhatsApp automations'],
  },
];
