...
const EVENT_TEMPLATE_MAP = {
  patient_created: {
    ...
    params: (data, clinicName) => [data.fullName || 'Patient', clinicName, 'The Team'],
  ...
  prescription_saved: {
    templateName: 'healthcare_prescription_issued',
    purpose: 'refill-reminder',
    params: (data, clinicName) => [
      data.patientName || 'Patient',
      data.doctorName || 'Doctor',
      data.prescriptionUrl || 'the clinic portal',
      clinicName,
    ],
    phone: (data) => data.patientPhone,
    toggle: 'prescription',
  ...
  follow_up: {
    templateName: 'healthcare_followup_reminder',
    purpose: 'follow-up',
    params: (data, clinicName) => [
      data.patientName || 'Patient',
      data.doctorName || 'Doctor',
      data.bookingUrl || 'our portal',
      clinicName,
    ],
    phone: (data) => data.patientPhone,
    toggle: 'followUp',
