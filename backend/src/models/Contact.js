...
contactSchema.index({ accountId: 1, projectId: 1, updatedAt: -1 });
contactSchema.index({ accountId: 1, projectId: 1, type: 1, updatedAt: -1 });
contactSchema.index({ accountId: 1, projectId: 1, isOptedIn: 1 });
