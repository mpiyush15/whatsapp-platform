...
const campaignSchema = new mongoose.Schema(
  {
    ...
    // Crash/duplicate protection for background campaign sends.
    // Keep this compact; delivery/read detail remains in Message records.
    sentPhones: {
      type: [String],
      default: []
    },
...
campaignSchema.index({ accountId: 1, projectId: 1, status: 1, createdAt: -1 });
