...
const conversationSchema = new mongoose.Schema({
  ...
  // Track if this conversation has ever received a message from the customer
  hasInboundMessage: {
    type: Boolean,
    default: false
  },
...
conversationSchema.index({ accountId: 1, projectId: 1, lastMessageAt: -1 });
conversationSchema.index({ accountId: 1, projectId: 1, status: 1, lastMessageAt: -1 });
